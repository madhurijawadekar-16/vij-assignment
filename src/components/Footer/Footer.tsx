	...
	return (
		<div className='mt-sm bg-primary-main f-pure-white'>
			<Box component='footer'>
				<Container className='mt-md mb-md footer'>
					<Grid
						container
						spacing={2}
						columns={18}
						className='hide-for-small-only a-center'
					>
						<Grid item xs={2}>
							<div className='f-capitalize f-400 h4 f-primary'>logo</div>
						</Grid>
					...
					<Box className='show-for-small-only'>
						...
						<Grid container columns={3} className='mb-sm'>
							<Grid item xs={3} className='display-item-sm ta-c mt-md'>
								<Link href='https://www.facebook.com/' color='inherit'>
									<Facebook />
								</Link>
					...
					<Box>
						<Typography variant='body2' align='center' className='f-xs mt-sm'>
